...
study_data = load_study_data(
    line_data_path=os.path.join(DATA_DIR, 'line_data_new.xlsx'), use_rrr=False)
...
ppa_352, npa_352 = tables_ppa_npa_combined_v4(groups, combined_groups)
...
combined_groups = compare_combined_collections(groups)
ppa_353, npa_353 = tables_ppa_npa_combined_v4(groups, combined_groups, suffix='_rrr')
